    ...
    return (SP_JSX.jsxs("div", { style: {
            ...
            background: "#0a0a0a",
                            ...
                            border: msg.role === "user" ? "1px solid #22c55e44" : "1px solid #4a4a4a",
                                ...
                                lineHeight: "1.4",
                                maxHeight: "140px",
                            } }), SP_JSX.jsx("div", { style: { display: "flex", justifyContent: "flex-end" }, children: SP_JSX.jsx(DFL.ButtonItem, { layout: "inline", onClick: () => handleSend(), disabled: busy || !input.trim() || !model, children: t("chat.btn.send") }) })] }) })] }));
}
